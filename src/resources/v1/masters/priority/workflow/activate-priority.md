# Activate Priority Workflow

**Title:** Enable/Activate Priority Record
...
flowchart TD
    ...
    E --> F(enablePriorityService.execute)
    ...
    L --> M[200 OK + Activated priority details]
```
...
### **Success Response:**
- Code: `200 OK`
- Message: `"priority_activated"`
- Data: Updated priority details (`is_active: true`)

# Activate District Workflow

**Title:** Enable/Activate District Record
...
flowchart TD
    ...
    E --> F(enableDistrictService.execute)
    ...
    L --> M[200 OK + Activated district details]
```
...
### **Success Response:**
- Code: `200 OK`
- Message: `"district_activated"`
- Data: Updated district details (`is_active: true`)

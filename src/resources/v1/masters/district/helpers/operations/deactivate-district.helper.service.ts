...
class deactivateDistrictHelperService {
  constructor() {}
  ...
  public async execute(
    ...
    try {
      ...
      rethrowIfKnown(error, "Error while deactivating district", errorMap);
    }
  }
}

export default new deactivateDistrictHelperService();

...
import deactivateDistrictHelperService from "../helpers/operations/deactivate-district.helper.service";
...
class deactivateDistrictService {
  public async execute(
    ...
    try {
      ...
      await deactivateDistrictHelperService.execute(
        district[0],
        session,
        userId,
        dbTransactions,
...
export default new deactivateDistrictService();

# Activate Country Workflow

**Title:** Enable/Activate Country Record
...
flowchart TD
    ...
    E --> F(enableCountryService.execute)
    ...
    L --> M[200 OK + Activated country details]
```
...
### **Success Response:**
- Code: `200 OK`
- Message: `"country_activated"`
- Data: Updated country details (`is_active: true`)
